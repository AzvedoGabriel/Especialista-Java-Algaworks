package com.algaworks.conjuntos;
...
//        Set<Cidade> cidades = new LinkedHashSet<>();
        ...
        for (Cidade cidade : cidades){
            System.out.printf("Código IBGE -> %d, Cidade -> %s, Numero Total de Habitantes -> %,d%n",
                    cidade.getCodigoIbge(), cidade.getNome(), cidade.getTotalHabitantes());
        }
    }
